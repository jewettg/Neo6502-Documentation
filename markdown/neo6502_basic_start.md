...
<td width="90%">
<b>Note:</b> If a program is imported or created and contains the use of GOSUB or GOTO with reference to line numbers, the program will stop working properly should the program get renumbered.   A program will get renumbered if the built-in commands <code>renumber</code> or <code>library</code> are used; or the result of editing a program with the built-in editor.  
</td>
</tr>
</table>
...
| **Control Structure** ![](file:///Users/jewettg/GitHub/Neo6502-Documentation/markdown/images/empty.gif?msec=1726629188151) | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `do`  ... <br> <br>`loop`                                                                                                  | Provides an infinite loop structure, with the ability to use the exit command to break out of the loop at any point.  <br> **Example:**<br><br><br><br>10 index = 0 <br>20 **do** <br>30   print “Hello World!” <br>40   index = index + 1 <br>50   if index > 10 then **exit** <br>60 **loop**<br><br><br><br><br>An optional `exit` keyword can be used, allowing you to exit or break out of the loop.                                                                                                                                                                                                                                    |
...
| `for` *var*`=`*start* `to`*end* ... <br>`next` *var*<br><br><br>`for` *var*`=`*start* `downto` *end* ... <br>`next` *var   | Provides a controlled loop (for / next) using a range of values.<br><br> *Note this is non-standard for/loop control, as there are limitations.<br>Limitations:<br><br>*<br><br>*- The index must be an integer.<br> <br>- The step is controlled using “to” (1) or “downto” (-1).<br> <br> next cannot specify an index and cannot be used to terminate loops (*using the wrong index).* Execution must operate in order and flow cannot be stopped arbitrarily.  *The variable after next is ignored.*  <br> **Example:**<br><br><br><br>10 for count = 10 downto 1 <br>20   print count<br>30 next count<br>40 print “Blast off!”<br><br> |
| `gosub` *expr*[2](#footnotes)                                                                                              | Call subroutine at line number.  A return command will return control to the line after the gosub call.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `goto` *expr*[2](#footnotes)                                                                                               | Transfer execution to a line number.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `return`[2](#footnotes)                                                                                                    | *See* *gosub.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `if` *expr* `then` *nn*[2](#footnotes)                                                                                     | Provide a single conditional, where execution is transferred to line number nn if the {expr} is true. **<br><br> NOTE:** `if` {expr} `goto` *nn* does not work.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `on error` *nn*[2](#footnotes)                                                                                             | Install an error handler, when execution is transferred to line number *nn* when an error occurs (*effectively a goto command*).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `if` *expr*: <br> .. <br>`else` <br> .. <br>`endif`                                                                        | Provides an if-then-else condition.  More than one line can be used between if and endif or between if and else and else and endif. *The* *else clause is optional.*   Code between if and else will only execute if the `expr` evaluates as true, and the code between else and endif will only execute if the `expr` evaluates as false.                                                                                                                                                                                                                                                                                                   |
| `repeat`  .. `until` *expr*                                                                                                | Provides a finite loop structure that will end when the expression following the until evaluates as true, else it will repeat while the expressing following the until evaluates as false.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `run`                                                                                                                      | Will execute the program in memory at the first and lowest<br> line number.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `stop`                                                                                                                     | Will terminate the program with an error.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `wait` *s*                                                                                                                 | Waits for *`s`*, where *`s`* is 1/100 seconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `while` *expr* ... `wend`                                                                                                  | Provides a finite loop structure that will end when the expression following the while evaluates as false, else it will repeat while the expressing following the while evaluates as true.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |

----

# Footnotes

1 Spaghetti code is a pejorative phrase for difficult-to-maintain and unstructured computer source code. See: [Spaghetti_code](https://en.wikipedia.org/wiki/Spaghetti_code)

2 Provided to use only for porting code to the NeoBASIC.  Continued use is not recommended as line numbers can change.  Line numbers will change and these statements (gosub and goto calls) will not be updated -- when the renumber or library commands; or use of the built-in editor.
